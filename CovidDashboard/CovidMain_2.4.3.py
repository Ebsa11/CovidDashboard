...
tab13 = Panel(child=fig13, title="Total Deaths")


fig14 = row(p14, data_table4)
tab14 = Panel(child=fig14, title="New Deaths")


fig15 = row(p15, data_table4)
tab15 = Panel(child=fig15, title="Total Deaths by Population")

fig16 = row(p16, data_table4)
tab16 = Panel(child=fig16, title="New Deaths by Population")



#12_4_22 TABS
fig17 = row(p17, data_table5)
tab17 = Panel(child=fig17, title="Total Deaths")


fig18 = row(p18, data_table5)
tab18 = Panel(child=fig18, title="New Deaths")


fig19 = row(p19, data_table5)
tab19 = Panel(child=fig19, title="Total Deaths by Population")

fig20 = row(p20, data_table5)
tab20 = Panel(child=fig20, title="New Deaths by Population")


#12_7_22 TABS
fig21 = row(p21, data_table6)
tab21 = Panel(child=fig21, title="Total Deaths")


fig22 = row(p22, data_table6)
tab22 = Panel(child=fig22, title="New Deaths")


fig23 = row(p23, data_table6)
tab23 = Panel(child=fig23, title="Total Deaths by Population")

fig24 = row(p24, data_table6)
tab24 = Panel(child=fig24, title="New Deaths by Population")


#12_8_22 TABS
fig25 = row(p25, data_table7)
tab25 = Panel(child=fig25, title="Total Deaths")


fig26 = row(p26, data_table7)
tab26 = Panel(child=fig26, title="New Deaths")


fig27 = row(p27, data_table7)
tab27 = Panel(child=fig27, title="Total Deaths by Population")

fig28 = row(p28, data_table7)
tab28 = Panel(child=fig28, title="New Deaths by Population")
...
MainTab4 = Panel(child=tabs4, title= "Data of 12-3-22")
MainTab5 = Panel(child=tabs5, title= "Data of 12-4-22")
MainTab6 = Panel(child=tabs6, title= "Data of 12-7-22")
MainTab7 = Panel(child=tabs7, title= "Data of 12-8-22")
...
tab3 = Panel(child=fig3, title="Total Deaths by Population")

fig4 = row(p4, data_table1)
tab4 = Panel(child=fig4, title="New Deaths by Population")

#Yesterday tabs
fig5 = row(p5, data_table2)
tab5 = Panel(child=fig5, title="Total Deaths")


fig6 = row(p6, data_table2)
tab6 = Panel(child=fig6, title="New Deaths")


fig7 = row(p7, data_table2)
tab7 = Panel(child=fig7, title="Total Deaths by Population")

fig8 = row(p8, data_table2)
tab8 = Panel(child=fig8, title="New Deaths by Population")


#2 Days ago tabs
fig9 = row(p9, data_table3)
tab9 = Panel(child=fig9, title="Total Deaths")


fig10 = row(p10, data_table3)
tab10 = Panel(child=fig10, title="New Deaths")


fig11 = row(p11, data_table3)
tab11 = Panel(child=fig11, title="Total Deaths by Population")

fig12 = row(p12, data_table3)
tab12 = Panel(child=fig12, title="New Deaths by Population")
