...
from bokeh.models import ColumnDataSource, HoverTool,TabPanel, Tabs, DataTable, TableColumn 
...
# Uncomment to save to a html file
...
tab3 = TabPanel(child=fig3, title="Total Deaths Population")

#Yesterday tabs
fig4 = row(p4, data_table2)
tab4 = TabPanel(child=fig4, title="Total Deaths")


fig5 = row(p5, data_table2)
tab5 = TabPanel(child=fig5, title="New Deaths")


fig6 = row(p6, data_table2)
tab6 = TabPanel(child=fig6, title="Total Deaths Population")


#2 Days ago tabs
fig7 = row(p7, data_table3)
tab7 = TabPanel(child=fig7, title="Total Deaths")


fig8 = row(p8, data_table3)
tab8 = TabPanel(child=fig8, title="New Deaths")


fig9 = row(p9, data_table3)
tab9 = TabPanel(child=fig9, title="Total Deaths Population")
